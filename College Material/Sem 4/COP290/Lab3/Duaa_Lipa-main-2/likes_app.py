...
@app.route("/<user_id>/likes/<username>")
...
@app.route("/<user_id>/likes", methods = ['POST'])
...
@app.route("/<user_id>/messages", methods = ['POST'])
...
@app.route("/<user_id>/messages/<username>")
...
@app.route("/<user_id>/messages/<username>", methods = ['POST'])
...
@app.route("/<user_id>/user/<username>")
...
def show_home(user_id):
  USER = database.load_user_from_db(user_id)
  return render_template('n-e-w-home.html', user = USER)
  
@app.route("/<user_id>/profile/edit_info")
